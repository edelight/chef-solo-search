...
Chef::Config[:encrypted_data_bag_secret] = "tests/data/encrypted_data_bag_secret"
...
class TestSecureDataBags < Test::Unit::TestCase

  def test_secure_data_bag
    item = secure_data_bag_item("encrypted_users", "mike")
